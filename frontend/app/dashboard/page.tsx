    ...
    return (
        <div className="space-y-8">
            ...
            <div>
                ...
                <p className="text-slate-500 mt-1">Welcome back, Mazen.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="relative">
                        ...
                        <p className="text-xs text-emerald-600 mt-2 font-medium flex items-center">
                            ↑ 12% <span className="text-slate-400 ml-1">last 30 days</span>
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="relative">
                        ...
                        <p className="text-3xl font-bold text-slate-800 mt-2">142h</p>
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm relative overflow-hidden group">
                    ...
                    <div className="relative">
                        <p className="text-sm font-medium text-slate-500 uppercase tracking-wider">Credits Remaining</p>
